<?php
	    ...
	    if($day_num == $DiaAct){
				 echo "<td bgcolor=blue>$day_num</td>";
			      ...
			      if($day_num>0 & $day_num<6){
	                echo "<td bgcolor=orange>$day_num</td>";
					}else{
				echo "<td>$day_num</td>";
				}
			}
	...
	echo "Tienes hasta el dia 20 de ".$title." del ".$year." Para realizar tu pago";
	
	echo "<br><br>";
	echo "<font color=red><strong>RECUERDA: </strong></font>";
	echo "Cada 5 dias de retardo se cobraran $50 de recargo hasta el dia 20 del mes actual ";

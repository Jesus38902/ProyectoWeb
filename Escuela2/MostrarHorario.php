<?php
	...
	$conexion=Conecta();
    $consulta="SELECT h.id_clave,m.horario,m.nombre,m.maestro,m.salon from materias as m,
     horario_alumno as h where (m.clave=h.id_clave) and h.id_alumno='$usuario'";
	$resultado=pg_query($conexion,$consulta);
    $NF=pg_num_rows($resultado);
    

     $consulta2="SELECT * from alumno where matricula='$usuario'";
